...
var g = &grammar{
	rules: []*rule{
		{
			name: "All",
			pos:  position{line: 4, col: 1, offset: 49},
			expr: &actionExpr{
				pos: position{line: 4, col: 7, offset: 57},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 4, col: 16, offset: 66},
							val:        "\n",
							ignoreCase: false,
						},
						&labeledExpr{
							pos:   position{line: 4, col: 21, offset: 71},
							label: "as",
							expr: &ruleRefExpr{
								pos:  position{line: 4, col: 24, offset: 74},
								name: "Articles",
							},
						},
						&ruleRefExpr{
							pos:  position{line: 4, col: 33, offset: 83},
							name: "EOF",
						},
					},
				},
		...
		},
		{
			...
			expr: &seqExpr{
				pos: position{line: 10, col: 12, offset: 171},
				exprs: []interface{}{
					&oneOrMoreExpr{
						pos: position{line: 10, col: 12, offset: 171},
						expr: &ruleRefExpr{
					...
					&charClassMatcher{
						pos:        position{line: 10, col: 27, offset: 186},
						val:        "[\\n]",
						chars:      []rune{'\n'},
						ignoreCase: false,
						inverted:   false,
		...
		{
			name: "PreambleEntry",
			pos:  position{line: 11, col: 1, offset: 191},
			expr: &actionExpr{
				pos: position{line: 11, col: 17, offset: 209},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							pos:   position{line: 11, col: 21, offset: 213},
							label: "k",
							expr: &ruleRefExpr{
								pos:  position{line: 11, col: 23, offset: 215},
								name: "PreambleEntryKey",
							},
						},
						&charClassMatcher{
							pos:        position{line: 11, col: 40, offset: 232},
							val:        "[\\t]",
							chars:      []rune{'\t'},
							ignoreCase: false,
							inverted:   false,
						...
						&litMatcher{
							pos:        position{line: 11, col: 45, offset: 237},
							val:        "\"",
							ignoreCase: false,
						},
						&labeledExpr{
							pos:   position{line: 11, col: 49, offset: 241},
							label: "v",
							expr: &ruleRefExpr{
								pos:  position{line: 11, col: 51, offset: 243},
								name: "PreambleEntryValue",
							},
						},
						&litMatcher{
							pos:        position{line: 11, col: 70, offset: 262},
							val:        "\"",
							ignoreCase: false,
						},
						&litMatcher{
							pos:        position{line: 11, col: 74, offset: 266},
							val:        "\n",
							ignoreCase: false,
						},
					},
		...
		{
			name: "PreambleEntryKey",
			pos:  position{line: 14, col: 1, offset: 339},
			expr: &actionExpr{
				pos: position{line: 14, col: 20, offset: 360},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 15, col: 22, offset: 422},
		...
		{
			name: "Articles",
			pos:  position{line: 17, col: 1, offset: 492},
			expr: &actionExpr{
				pos: position{line: 17, col: 12, offset: 505},
				run: (*parser).callonArticles1,
				expr: &labeledExpr{
					pos:   position{line: 17, col: 12, offset: 505},
					label: "asitf",
					expr: &zeroOrMoreExpr{
						pos: position{line: 17, col: 18, offset: 511},
						expr: &ruleRefExpr{
							pos:  position{line: 17, col: 18, offset: 511},
							name: "Article",
						},
		...
		{
			name: "Article",
			pos:  position{line: 25, col: 1, offset: 678},
			expr: &actionExpr{
				pos: position{line: 25, col: 11, offset: 690},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						&labeledExpr{
							...
							label: "hwsitf",
							expr: &oneOrMoreExpr{
								pos: position{line: 25, col: 18, offset: 697},
								expr: &ruleRefExpr{
									pos:  position{line: 25, col: 18, offset: 697},
									name: "Headword",
								},
						...
						&labeledExpr{
							pos:   position{line: 25, col: 28, offset: 707},
							label: "body",
							expr: &ruleRefExpr{
								pos:  position{line: 25, col: 33, offset: 712},
								name: "Body",
							},
						},
						&litMatcher{
							pos:        position{line: 25, col: 38, offset: 717},
							val:        "\n",
							ignoreCase: false,
						},
					},
		...
		{
			name: "Headword",
			pos:  position{line: 37, col: 1, offset: 946},
			expr: &actionExpr{
				pos: position{line: 37, col: 12, offset: 959},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 37, col: 21, offset: 968},
							val:        "\n",
							ignoreCase: false,
						},
					},
		...
		{
			name: "Body",
			pos:  position{line: 41, col: 1, offset: 1006},
			expr: &actionExpr{
				pos: position{line: 41, col: 8, offset: 1015},
				run: (*parser).callonBody1,
				expr: &oneOrMoreExpr{
					pos: position{line: 41, col: 8, offset: 1015},
					expr: &seqExpr{
						pos: position{line: 41, col: 9, offset: 1016},
						exprs: []interface{}{
							&litMatcher{
								pos:        position{line: 41, col: 9, offset: 1016},
								val:        "\t",
							...
							&oneOrMoreExpr{
								pos: position{line: 41, col: 14, offset: 1021},
								expr: &charClassMatcher{
									pos:        position{line: 41, col: 14, offset: 1021},
									val:        "[^\\n]",
									chars:      []rune{'\n'},
							...
							&litMatcher{
								pos:        position{line: 41, col: 21, offset: 1028},
								val:        "\n",
								ignoreCase: false,
							},
						},
		...
		{
			name: "EOF",
			pos:  position{line: 45, col: 1, offset: 1068},
			expr: &notExpr{
				pos: position{line: 45, col: 7, offset: 1076},
				expr: &anyMatcher{
					line: 45, col: 8, offset: 1077,
				},
			},
		},
	},
