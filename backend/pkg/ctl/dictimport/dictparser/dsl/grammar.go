...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 26, col: 46, offset: 414},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&labeledExpr{
							pos:   position{line: 26, col: 50, offset: 418},
							label: "v",
							expr: &ruleRefExpr{
								pos:  position{line: 26, col: 52, offset: 420},
								name: "PreambleEntryValue",
							},
						},
						&litMatcher{
							pos:        position{line: 26, col: 71, offset: 439},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&litMatcher{
							pos:        position{line: 26, col: 75, offset: 443},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 29, col: 20, offset: 543},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 30, col: 22, offset: 605},
		...
		{
			name: "Articles",
			pos:  position{line: 32, col: 1, offset: 675},
			expr: &actionExpr{
				pos: position{line: 32, col: 12, offset: 688},
				run: (*parser).callonArticles1,
				expr: &labeledExpr{
					pos:   position{line: 32, col: 12, offset: 688},
					label: "asitf",
					expr: &zeroOrMoreExpr{
						pos: position{line: 32, col: 18, offset: 694},
						expr: &ruleRefExpr{
							pos:  position{line: 32, col: 18, offset: 694},
							name: "Article",
						},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 40, col: 11, offset: 883},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						&labeledExpr{
							...
							label: "hwsitf",
							expr: &oneOrMoreExpr{
								pos: position{line: 40, col: 18, offset: 890},
								expr: &ruleRefExpr{
									pos:  position{line: 40, col: 18, offset: 890},
									name: "Headword",
								},
						...
						&labeledExpr{
							...
							label: "body",
							expr: &ruleRefExpr{
								pos:  position{line: 40, col: 39, offset: 911},
								name: "Body",
							},
						},
						&zeroOrMoreExpr{
							pos: position{line: 40, col: 44, offset: 916},
							expr: &litMatcher{
								pos:        position{line: 40, col: 44, offset: 916},
								val:        "\n",
								ignoreCase: false,
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 52, col: 12, offset: 1164},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 52, col: 21, offset: 1173},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		{
			name: "Body",
			pos:  position{line: 56, col: 1, offset: 1211},
			expr: &actionExpr{
				pos: position{line: 56, col: 8, offset: 1220},
				run: (*parser).callonBody1,
				expr: &oneOrMoreExpr{
					pos: position{line: 56, col: 8, offset: 1220},
					expr: &seqExpr{
						pos: position{line: 56, col: 9, offset: 1221},
						exprs: []interface{}{
							&litMatcher{
								pos:        position{line: 56, col: 9, offset: 1221},
								val:        "\t",
							...
							&oneOrMoreExpr{
								pos: position{line: 56, col: 14, offset: 1226},
								expr: &charClassMatcher{
									pos:        position{line: 56, col: 14, offset: 1226},
									val:        "[^\\n]",
									chars:      []rune{'\n'},
							...
							&litMatcher{
								pos:        position{line: 56, col: 21, offset: 1233},
								val:        "\n",
								ignoreCase: false,
								want:       "\"\\n\"",
							},
		...
		{
			name: "EOF",
			pos:  position{line: 60, col: 1, offset: 1273},
			expr: &notExpr{
				pos: position{line: 60, col: 7, offset: 1281},
				expr: &anyMatcher{
					line: 60, col: 8, offset: 1282,
				},
			},
		},
	},
