...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							pos:   position{line: 19, col: 22, offset: 239},
							label: "as",
							expr: &ruleRefExpr{
								pos:  position{line: 19, col: 25, offset: 242},
								name: "Articles",
							},
						},
						&ruleRefExpr{
							pos:  position{line: 19, col: 34, offset: 251},
							name: "EOF",
						},
					},
				},
		...
		},
		{
			...
			expr: &oneOrMoreExpr{
				pos: position{line: 25, col: 12, offset: 352},
				expr: &ruleRefExpr{
					pos:  position{line: 25, col: 12, offset: 352},
					name: "PreambleEntry",
				},
		...
		{
			name: "PreambleEntry",
			pos:  position{line: 26, col: 1, offset: 367},
			expr: &actionExpr{
				pos: position{line: 26, col: 17, offset: 385},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							pos:   position{line: 26, col: 21, offset: 389},
							label: "k",
							expr: &ruleRefExpr{
								pos:  position{line: 26, col: 23, offset: 391},
								name: "PreambleEntryKey",
							},
						},
						&charClassMatcher{
							pos:        position{line: 26, col: 40, offset: 408},
							val:        "[\\t]",
							chars:      []rune{'\t'},
							ignoreCase: false,
							inverted:   false,
						...
						&litMatcher{
							pos:        position{line: 26, col: 45, offset: 413},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&labeledExpr{
							pos:   position{line: 26, col: 49, offset: 417},
							label: "v",
							expr: &ruleRefExpr{
								pos:  position{line: 26, col: 51, offset: 419},
								name: "PreambleEntryValue",
							},
						},
						&litMatcher{
							pos:        position{line: 26, col: 70, offset: 438},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&litMatcher{
							pos:        position{line: 26, col: 74, offset: 442},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		{
			name: "PreambleEntryKey",
			pos:  position{line: 29, col: 1, offset: 521},
			expr: &actionExpr{
				pos: position{line: 29, col: 20, offset: 542},
		...
		{
			name: "PreambleEntryValue",
			pos:  position{line: 30, col: 1, offset: 581},
			expr: &actionExpr{
		...
		{
			name: "Articles",
			pos:  position{line: 32, col: 1, offset: 674},
			expr: &actionExpr{
				pos: position{line: 32, col: 12, offset: 687},
				run: (*parser).callonArticles1,
				expr: &labeledExpr{
					pos:   position{line: 32, col: 12, offset: 687},
					label: "asitf",
					expr: &zeroOrMoreExpr{
						pos: position{line: 32, col: 18, offset: 693},
						expr: &ruleRefExpr{
							pos:  position{line: 32, col: 18, offset: 693},
							name: "Article",
						},
		...
		{
			name: "Article",
			pos:  position{line: 40, col: 1, offset: 870},
			expr: &actionExpr{
				pos: position{line: 40, col: 11, offset: 882},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						&labeledExpr{
							...
							label: "hwsitf",
							expr: &oneOrMoreExpr{
								pos: position{line: 40, col: 18, offset: 889},
								expr: &ruleRefExpr{
									pos:  position{line: 40, col: 18, offset: 889},
									name: "Headword",
								},
						...
						&labeledExpr{
							pos:   position{line: 40, col: 28, offset: 899},
							label: "body",
							expr: &ruleRefExpr{
								pos:  position{line: 40, col: 33, offset: 904},
								name: "Body",
							},
						},
						&zeroOrOneExpr{
							pos: position{line: 40, col: 38, offset: 909},
							expr: &litMatcher{
								pos:        position{line: 40, col: 38, offset: 909},
								val:        "\n",
								ignoreCase: false,
		...
		{
			name: "Headword",
			pos:  position{line: 52, col: 1, offset: 1144},
			expr: &actionExpr{
				pos: position{line: 52, col: 12, offset: 1157},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 52, col: 21, offset: 1166},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		{
			name: "Body",
			pos:  position{line: 56, col: 1, offset: 1204},
			expr: &actionExpr{
				pos: position{line: 56, col: 8, offset: 1213},
				run: (*parser).callonBody1,
				expr: &oneOrMoreExpr{
					pos: position{line: 56, col: 8, offset: 1213},
					expr: &seqExpr{
						pos: position{line: 56, col: 9, offset: 1214},
						exprs: []interface{}{
							&litMatcher{
								pos:        position{line: 56, col: 9, offset: 1214},
								val:        "\t",
							...
							&oneOrMoreExpr{
								pos: position{line: 56, col: 14, offset: 1219},
								expr: &charClassMatcher{
									pos:        position{line: 56, col: 14, offset: 1219},
									val:        "[^\\n]",
									chars:      []rune{'\n'},
							...
							&litMatcher{
								pos:        position{line: 56, col: 21, offset: 1226},
								val:        "\n",
								ignoreCase: false,
								want:       "\"\\n\"",
							},
		...
		},
		{
			...
			expr: &notExpr{
				pos: position{line: 60, col: 7, offset: 1274},
				expr: &anyMatcher{
					line: 60, col: 8, offset: 1275,
				},
			},
		},
	},
