...
var g = &grammar{
	rules: []*rule{
		{
			name: "All",
			pos:  position{line: 19, col: 1, offset: 212},
			expr: &actionExpr{
				pos: position{line: 19, col: 7, offset: 220},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							...
							label: "as",
							expr: &ruleRefExpr{
								pos:  position{line: 19, col: 25, offset: 238},
								name: "Articles",
							},
						},
						&ruleRefExpr{
		...
		},
		{
			...
			expr: &oneOrMoreExpr{
				pos: position{line: 25, col: 12, offset: 348},
				expr: &ruleRefExpr{
					pos:  position{line: 25, col: 12, offset: 348},
					name: "PreambleEntry",
				},
		...
		{
			name: "PreambleEntry",
			pos:  position{line: 26, col: 1, offset: 363},
			expr: &actionExpr{
				pos: position{line: 26, col: 17, offset: 381},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							pos:   position{line: 26, col: 21, offset: 385},
							label: "k",
							expr: &ruleRefExpr{
								pos:  position{line: 26, col: 23, offset: 387},
								name: "PreambleEntryKey",
							},
						},
						&charClassMatcher{
							pos:        position{line: 26, col: 40, offset: 404},
							val:        "[\\t ]",
							chars:      []rune{'\t', ' '},
							ignoreCase: false,
							inverted:   false,
						...
						&litMatcher{
							pos:        position{line: 26, col: 46, offset: 410},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&labeledExpr{
							pos:   position{line: 26, col: 50, offset: 414},
							label: "v",
							expr: &ruleRefExpr{
								pos:  position{line: 26, col: 52, offset: 416},
								name: "PreambleEntryValue",
							},
						},
						&litMatcher{
							pos:        position{line: 26, col: 71, offset: 435},
							val:        "\"",
							ignoreCase: false,
							want:       "\"\\\"\"",
						},
						&litMatcher{
							pos:        position{line: 26, col: 75, offset: 439},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		{
			name: "PreambleEntryKey",
			pos:  position{line: 29, col: 1, offset: 518},
			expr: &actionExpr{
				pos: position{line: 29, col: 20, offset: 539},
		...
		{
			name: "PreambleEntryValue",
			pos:  position{line: 30, col: 1, offset: 578},
			expr: &actionExpr{
				pos: position{line: 30, col: 22, offset: 601},
		...
		{
			name: "Articles",
			pos:  position{line: 32, col: 1, offset: 671},
			expr: &actionExpr{
				pos: position{line: 32, col: 12, offset: 684},
				run: (*parser).callonArticles1,
				expr: &labeledExpr{
					pos:   position{line: 32, col: 12, offset: 684},
					label: "asitf",
					expr: &zeroOrMoreExpr{
						pos: position{line: 32, col: 18, offset: 690},
						expr: &ruleRefExpr{
							pos:  position{line: 32, col: 18, offset: 690},
							name: "Article",
						},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 40, col: 11, offset: 879},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						&labeledExpr{
							...
							label: "hwsitf",
							expr: &oneOrMoreExpr{
								pos: position{line: 40, col: 18, offset: 886},
								expr: &ruleRefExpr{
									pos:  position{line: 40, col: 18, offset: 886},
									name: "Headword",
								},
						...
						&zeroOrMoreExpr{
							pos: position{line: 40, col: 28, offset: 896},
							expr: &litMatcher{
								pos:        position{line: 40, col: 28, offset: 896},
								val:        "\n",
								ignoreCase: false,
						...
						&labeledExpr{
							pos:   position{line: 40, col: 34, offset: 902},
							label: "body",
							expr: &ruleRefExpr{
								pos:  position{line: 40, col: 39, offset: 907},
								name: "Body",
							},
						},
						&zeroOrMoreExpr{
							pos: position{line: 40, col: 44, offset: 912},
							expr: &litMatcher{
								pos:        position{line: 40, col: 44, offset: 912},
								val:        "\n",
								ignoreCase: false,
		...
		{
			name: "Headword",
			pos:  position{line: 52, col: 1, offset: 1147},
			expr: &actionExpr{
				pos: position{line: 52, col: 12, offset: 1160},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&litMatcher{
							pos:        position{line: 52, col: 21, offset: 1169},
							val:        "\n",
							ignoreCase: false,
							want:       "\"\\n\"",
						},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 56, col: 8, offset: 1216},
				run: (*parser).callonBody1,
				expr: &oneOrMoreExpr{
					pos: position{line: 56, col: 8, offset: 1216},
					expr: &seqExpr{
						pos: position{line: 56, col: 9, offset: 1217},
						exprs: []interface{}{
							&litMatcher{
								pos:        position{line: 56, col: 9, offset: 1217},
								val:        "\t",
							...
							&oneOrMoreExpr{
								pos: position{line: 56, col: 14, offset: 1222},
								expr: &charClassMatcher{
									pos:        position{line: 56, col: 14, offset: 1222},
									val:        "[^\\n]",
									chars:      []rune{'\n'},
							...
							&litMatcher{
								pos:        position{line: 56, col: 21, offset: 1229},
								val:        "\n",
								ignoreCase: false,
								want:       "\"\\n\"",
							},
		...
		{
			name: "EOF",
			pos:  position{line: 60, col: 1, offset: 1269},
			expr: &notExpr{
				pos: position{line: 60, col: 7, offset: 1277},
				expr: &anyMatcher{
					line: 60, col: 8, offset: 1278,
				},
			},
		},
	},
