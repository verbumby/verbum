...
export const SupportPage: React.FC = () => {
	...
	return <>
		...
		<div className='mx-1 mb-3'>
			...
			<p></p>
			<p><a href="https://verbum.by/">Verbum.by</a> можна падтрымаць фінансава праз <a href="https://ko-fi.com/verbumby" target='_blank' rel="noopener noreferrer">Ko-Fi</a> ці <a href="https://github.com/sponsors/verbumby" target='_blank' rel="noopener noreferrer">GitHub</a>. Гэта дазволіць пакрываць аплату сервера і даменнага імя, а таксама дадасць матывацыі падтрымліваць і паляпшаць праект.</p>
